...
# Write points
writeOGR(points3857, ".", "sample_points30", driver="ESRI Shapefile", overwrite_layer=TRUE)

# Also to WGS84 for GeoSurvey
pointsWGS         <- spTransform(points3857, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
writeOGR(pointsWGS, ".", "sample_points30_WGS84", driver="ESRI Shapefile", overwrite_layer=TRUE)
