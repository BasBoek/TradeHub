...
nr_points1 <- 30000 # over 3959   grids cells =  points / cell
nr_points2 <- 20000 # over 3341   grids cells =  points / cell
nr_points3 <- 30000 # over 15505  grids cells =  points / cell
nr_points4 <- 20000 # over 142673 grids cells =  points / cell
...
# Write points
writeOGR(points3857, ".", "sample_points32", driver="ESRI Shapefile", overwrite_layer=TRUE)

# Also to WGS84 for GeoSurvey
pointsWGS         <- spTransform(points3857, "+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs")
writeOGR(pointsWGS, ".", "sample_points32_WGS84", driver="ESRI Shapefile", overwrite_layer=TRUE)
...
write.csv(csv_coords, "sample_points_32_WGS.csv", row.names = F, col.names = F)
